...
_ADMIN_ONLY = frozenset(
    {
        ...
        C.SHARED_MEMORY_CREATE,
        C.SHARED_MEMORY_EDIT,
        C.SHARED_MEMORY_DELETE,
        C.SHARED_MEMORY_RESTORE,
        C.SHARED_MEMORY_CANDIDATE_APPROVE,
        C.SHARED_MEMORY_CANDIDATE_REJECT,
